...
- Fixed an issue where the `send_certificate_chain` keyword argument was not being honored when using certs with `OnBehalfOfCredential`. ([#36538](https://github.com/Azure/azure-sdk-for-python/pull/36538))
